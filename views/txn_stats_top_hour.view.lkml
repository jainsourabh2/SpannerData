view: txn_stats_top_hour {
  sql_table_name: `spanner_sys.txn_stats_top_hour`
    ;;
...
view: txn_stats_top_hour__read_columns {
  dimension: txn_stats_top_hour__read_columns {
    type: string
    sql: txn_stats_top_hour__read_columns ;;
  }
}

view: txn_stats_top_hour__write_delete_tables {
  dimension: txn_stats_top_hour__write_delete_tables {
    type: string
    sql: txn_stats_top_hour__write_delete_tables ;;
  }
}

view: txn_stats_top_hour__write_constructive_columns {
  dimension: txn_stats_top_hour__write_constructive_columns {
    type: string
    sql: txn_stats_top_hour__write_constructive_columns ;;
  }
}
