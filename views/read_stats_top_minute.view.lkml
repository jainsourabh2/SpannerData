view: read_stats_top_minute {
  sql_table_name: `spanner_sys.READ_STATS_TOP_MINUTE`
    ;;
...
view: read_stats_top_minute__read_columns {
  dimension: read_stats_top_minute__read_columns {
    type: string
    sql: read_stats_top_minute__read_columns ;;
  }
}
