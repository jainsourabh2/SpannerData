view: read_stats_top_hour {
  sql_table_name: `spanner_sys.READ_STATS_TOP_HOUR`
    ;;
...
view: read_stats_top_hour__read_columns {
  dimension: read_stats_top_hour__read_columns {
    type: string
    sql: read_stats_top_hour__read_columns ;;
  }
}
